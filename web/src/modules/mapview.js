...
/* ---------- мост для Vite: тот же объект, что и window.MapView ----------
   Легаси-скрипты (part1/part2 пока не модульные) продолжают видеть
   window.MapView без изменений; сборка получает то же самое через import. */
export const MapView = window.MapView;
