...
/* ---------- мост для Vite: тот же объект, что и window.Profile ----------
   Легаси-скрипты (part1/part2 пока не модульные) продолжают видеть
   window.Profile без изменений; сборка получает то же самое через import. */
export const Profile = window.Profile;
