...
/* ---------- мост для Vite: тот же объект, что и window.CONTROLS ----------
   Легаси-скрипты (part1/part2 пока не модульные) продолжают видеть
   window.CONTROLS без изменений; сборка получает то же самое через import. */
export const CONTROLS = window.CONTROLS;
